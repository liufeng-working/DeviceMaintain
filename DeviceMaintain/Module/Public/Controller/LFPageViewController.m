//
//  LFPageViewController.m
//

#import "LFPageViewController.h"
#import "LFTabView.h"

@interface LFPageViewController ()<LFTabViewDelegate, UIScrollViewDelegate>

@property(nonatomic,weak) LFTabView *topView;
...
@implementation LFPageViewController

- (LFTabView *)topView
{
    if (!_topView) {
        LFTabView *top = [[LFTabView alloc] init];
        top.delegate = self;
